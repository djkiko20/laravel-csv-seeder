...
class CsvSeeder extends Seeder
{
    ...
    /**
     * Get clean text ( ex. form "Test text" to Test text  )
     *
     * $first_character is first character in string
     *
     * @var string
     */
    public $first_character = '';

    /**
     * Get clean text ( ex. form "Test text" to Test text  )
     *
     * $last_character is last character in string
     *
     * @var string
     */
    public $last_character = '';
    ...
    public function readRow(array $row, array $mapping)
    {
        ...
        foreach ($mapping as $csvCol => $dbCol) {
            if ( ! isset( $row[$csvCol] ) || $row[$csvCol] === '') {
                ...
                if ($this->first_character != '' && $this->last_character != '') { // if first and last character is set
                    $row_values[$dbCol] = $this->extract_unit($row[$csvCol], $this->first_character,
                        $this->last_character);
                } else {
    ...
    /**
     * Extract unit between $first_character and $last_character
     *
     * @param string $string
     * @param string $start
     * @param string $end
